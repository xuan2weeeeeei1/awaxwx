...
"for(i=0;i<6;i++)cout<<xwx[0]<<awa[i]<<xwx[0]<<xwx[1]<<endl;",
"for(i=0;i<10;i++)cout<<xwx[0]<<char(xwx[2]+i)<<char(xwx[2]+i)<<xwx[0]<<xwx[5];",
"cout<<endl; for(i=0;i<10;i++)cout<<xwx[0]<<awa[15+i]<<xwx[0]<<xwx[1]<<endl;",
"cout<<endl<<xwx[0]<<awa[25]<<xwx[0]<<xwx[4]<<xwx[1]<<endl;",
